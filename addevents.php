...
if (isset($_POST['submit'])) {
    ...
    $time=$_POST['time'];
        ...
        if(mysqli_query($pc, "INSERT INTO eventnotification  (eventname,eventdate,eventtime) VALUES ('".$ename."','".$edate."','".$time."')"))
        {
        echo "<script>alert('added sucessfuly');window.location='viewevents.php'</script>";
    }
}
?>
    <!-- Main Menu area End-->
                    ...
                    <div class="form-example-wrap mg-t-30">
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">Event Time</label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
