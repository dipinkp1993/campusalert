...
?>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									<div class="breadcomb-icon">
										<i class="Campus Alert-icon Campus Alert-app"></i>
									</div>
    ...
    <div class="notification-area">
        <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            ...
                                            {
                                            ?>
                                            <option <?php if(isset($_GET['dept'])){if($_GET['dept']== $row[0]) { ?> selected <?php }} ?> value="<?php echo $row[0];?>"><?php echo $row[1];?></option>
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                           <select class="form-control" name="y" required="">
                                            ...
                                            {
                                            ?>
                                            <option <?php if(isset($_GET['semid'])){if($_GET['semid']== $row[0]) { ?> selected <?php }} ?> value="<?php echo $row[0];?>"><?php echo $row[1];?></option>
            ...
            if (isset($_POST['submit'])||isset($_GET['gsub'])) {
    $department = $_POST['d'];
    $year = $_POST['y'];
    $dat=$_POST['edate'];
    echo $_GET['dept'];
    ...
    if(isset($_GET['gsub']))
    {
        echo "select * from students where deptid='$_GET[dept]' and semid='$_GET[semid]";
        $result=mysqli_query($pc,"select * from students where deptid='$_GET[dept]' and semid='$_GET[semid]'");
        echo "get";
    }
    else
    {
        echo "select * from students where deptid='$department' and semid='$year'";
...
?>
            <div class="row">
                ...
                if(isset($_GET['gsub'])){
                   echo $z="select * from student_attendence where studid='$ar[studentid]' and dat='$_GET[da]";
                  
                  echo "hii";
                }
                else
                {
                 echo $z="select * from student_attendence where studid='$ar[studentid]' and dat='$dat'";
                 echo "posthii";
