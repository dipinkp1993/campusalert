...
if (isset($_POST['submit'])) {
    ...
    $year = $_POST['y'];
    $mdate=$_POST['edate'];
    $details=$_POST['famount'];

       
        if(mysqli_query($pc, "INSERT INTO fees (feeamount,duedate,deptid,semid) VALUES ('".$details."','".$mdate."','".$department."','".$year."')"))
        {
        echo "<script>alert('added sucessfuly');window.location='viewfeedetails.php'</script>";
    }
}
?>
    <!-- Main Menu area End-->
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Add Fee Notification</h2>
										<p> <span class="bread-ntd">Fee details</span></p>
									</div>
								</div>
							</div>
                    ...
                    <div class="form-example-wrap mg-t-30">
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">Due Date</label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">Fee Amount</label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control input-sm" name="famount" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
